tng-sla-mgmt [![Build Status](https://jenkins.sonata-nfv.eu/buildStatus/icon?job=son-mano-framework-pipeline/master)]https://jenkins.sonata-nfv.eu/job/son-mano-framework-pipeline/job/master/)
